...
{
public:
	struct FStringClassReference                       PerceptionSystemClassName;                                // 0x0048(0x0010) (Edit, ZeroConstructor, Config, GlobalConfig)
	struct FStringClassReference                       HotSpotManagerClassName;                                  // 0x0058(0x0010) (Edit, ZeroConstructor, Config, GlobalConfig)
...
{
public:
	class AAIController*                               OwnerController;                                          // 0x0068(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bUseNavAgentGoalLocation : 1;                             // 0x00C8(0x0001) (Edit)
...
{
public:
	struct FName                                       QueryName;                                                // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UEnvQueryOption*>                     Options;                                                  // 0x0030(0x0010) (ZeroConstructor)
...
public:
	...
	TArray<class UEnvQueryInstanceBlueprintWrapper*>   GCShieldedWrappers;                                       // 0x00B8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x58];                                      // 0x00C8(0x0058) MISSED OFFSET
	double                                             MaxAllowedTestingTime;                                    // 0x0120(0x0008) (ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x03B0(0x000C) (ZeroConstructor, IsPlainOldData)
	...
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x03C8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x03CC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x03D0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	struct FVector                                     GoalLocation;                                             // 0x00D8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
