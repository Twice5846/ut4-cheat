...
struct FCameraFocusSettings
{
	...
	unsigned char                                      bSmoothFocusChanges : 1;                                  // 0x0020(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	float                                              FocusSmoothingInterpSpeed;                                // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusOffset;                                              // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FNamedFilmbackPreset
{
	...
	struct FCameraFilmbackSettings                     FilmbackSettings;                                         // 0x0010(0x000C) (ZeroConstructor, IsPlainOldData)
...
{
	struct FString                                     Name;                                                     // 0x0000(0x0010) (ZeroConstructor)
	struct FCameraLensSettings                         LensSettings;                                             // 0x0010(0x0014) (ZeroConstructor, IsPlainOldData)
