...
struct FQosRegionInfo
{
	...
	EQosCompletionResult                               Result;                                                   // 0x0040(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	...
	struct FDateTime                                   LastCheckTimestamp;                                       // 0x0068(0x0008) (ZeroConstructor, Transient)
};
