...
{
	EFontLoadingPolicy__PreLoad    = 0,
	EFontLoadingPolicy__Stream     = 1,
	EFontLoadingPolicy__EFontLoadingPolicy_MAX = 2
};
...
struct FSlateBrush
{
	...
	struct FLinearColor                                Tint;                                                     // 0x0024(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FTextBlockStyle : public FSlateWidgetStyle
{
	struct FSlateFontInfo                              Font;                                                     // 0x0008(0x0068) (Edit, BlueprintVisible)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0070(0x0028) (Edit, BlueprintVisible)
	struct FVector2D                                   ShadowOffset;                                             // 0x0098(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                ShadowColorAndOpacity;                                    // 0x00A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FSlateColor                                 SelectedBackgroundColor;                                  // 0x00B0(0x0028) (Edit)
	struct FLinearColor                                HighlightColor;                                           // 0x00D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FTypefaceEntry
{
	...
	struct FFontData                                   Font;                                                     // 0x0008(0x0018)
};
...
struct FWindowStyle : public FSlateWidgetStyle
{
	...
	struct FSlateBrush                                 OutlineBrush;                                             // 0x0E60(0x0090) (Edit, BlueprintVisible)
	struct FSlateColor                                 OutlineColor;                                             // 0x0EF0(0x0028) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BorderBrush;                                              // 0x0F18(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BackgroundBrush;                                          // 0x0FA8(0x0090) (Edit, BlueprintVisible)
	struct FSlateBrush                                 ChildBackgroundBrush;                                     // 0x1038(0x0090) (Edit, BlueprintVisible)
};
