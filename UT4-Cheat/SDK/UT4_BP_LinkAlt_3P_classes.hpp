...
// BlueprintGeneratedClass BP_LinkAlt_3P.BP_LinkAlt_3P_C
// 0x0125 (0x04AD - 0x0388)
class ABP_LinkAlt_3P_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_LinkAlt_3P.BP_LinkAlt_3P_C");
		return ptr;
	}
	...
	void MaterialCheck();
	void ExecuteUbergraph_BP_LinkAlt_3P(int EntryPoint);
};
