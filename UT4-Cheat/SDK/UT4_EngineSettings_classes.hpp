...
{
public:
	struct FStringAssetReference                       EditorStartupMap;                                         // 0x0028(0x0010) (Edit, ZeroConstructor, Config)
	struct FString                                     LocalMapOptions;                                          // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
	struct FStringAssetReference                       TransitionMap;                                            // 0x0048(0x0010) (Edit, ZeroConstructor, Config)
	...
	struct FStringAssetReference                       GameDefaultMap;                                           // 0x0070(0x0010) (Edit, ZeroConstructor, Config)
	struct FStringAssetReference                       ServerDefaultMap;                                         // 0x0080(0x0010) (Edit, ZeroConstructor, Config)
