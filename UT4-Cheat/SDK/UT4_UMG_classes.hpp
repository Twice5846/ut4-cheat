...
{
public:
	struct FRichCurve                                  Translation[0x2];                                         // 0x00D0(0x0078)
	struct FRichCurve                                  Rotation;                                                 // 0x01C0(0x0078)
	struct FRichCurve                                  Scale[0x2];                                               // 0x0238(0x0078)
	struct FRichCurve                                  Shear[0x2];                                               // 0x0328(0x0078)
...
{
public:
	struct FRichCurve                                  TopCurve;                                                 // 0x00D0(0x0078)
	struct FRichCurve                                  LeftCurve;                                                // 0x0148(0x0078)
	struct FRichCurve                                  RightCurve;                                               // 0x01C0(0x0078)
	struct FRichCurve                                  BottomCurve;                                              // 0x0238(0x0078)
...
public:
	...
	class UWidgetAnimation*                            Animation;                                                // 0x0380(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D20(0x0014) (Edit, ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnSelectionChanged;                                       // 0x0D30(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnOpening;                                                // 0x0D40(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x40];                                      // 0x0D50(0x0040) MISSED OFFSET
...
{
public:
	struct FInputChord                                 SelectedKey;                                              // 0x0118(0x0020) (BlueprintVisible, BlueprintReadOnly)
	struct FSlateFontInfo                              Font;                                                     // 0x0138(0x0068) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FMargin                                     Margin;                                                   // 0x01A0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x01B0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FText                                       KeySelectionText;                                         // 0x01C0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bAllowModifierKeys;                                       // 0x01D8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x01D9(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnKeySelected;                                            // 0x01E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnIsSelectingKeyChanged;                                  // 0x01F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	float                                              BlurStrength;                                             // 0x0130(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAutoRadiusCalculation;                           // 0x0134(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0135(0x0003) MISSED OFFSET
	int                                                BlurRadius;                                               // 0x0138(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x013C(0x0004) MISSED OFFSET
	struct FSlateBrush                                 LowQualityFallbackBrush;                                  // 0x0140(0x0090) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x10];                                      // 0x01D0(0x0010) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class UMG.BackgroundBlurWidget");
		return ptr;
	}
...
public:
	...
	struct FVector2D                                   DesiredSizeScale;                                         // 0x0228(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x02F8(0x0014) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x0318(0x0014) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FLinearColor                                SliderBarColor;                                           // 0x0384(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                SliderHandleColor;                                        // 0x0394(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FSlateFontInfo                              Font;                                                     // 0x0388(0x0068) (Deprecated)
	bool                                               AllowContextMenu;                                         // 0x03F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x03F1(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x03F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0408(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	bool                                               AllowContextMenu;                                         // 0x0BF8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FLinearColor                                ForegroundColor;                                          // 0x0C70(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0C80(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FLinearColor                                ReadOnlyForegroundColor;                                  // 0x0C90(0x0010) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	struct FLinearColor                                Color;                                                    // 0x01D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UMovieScene*                                 MovieScene;                                               // 0x02F8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FWidgetAnimationBinding>             AnimationBindings;                                        // 0x0300(0x0010) (ZeroConstructor)
...
{
public:
	class UWidgetTree*                                 WidgetTree;                                               // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x0350(0x0010) (ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x0360(0x0010) (ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x0370(0x0010) (ZeroConstructor)
	unsigned char                                      bCanEverTick : 1;                                         // 0x0380(0x0001)
	unsigned char                                      bCanEverPaint : 1;                                        // 0x0380(0x0001)
...
{
public:
	EWidgetSpace                                       Space;                                                    // 0x0750(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0751(0x0007) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x0758(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0760(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0768(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0769(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x076A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x076C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LastWidgetRenderTime;                                     // 0x0770(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0774(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0775(0x0003) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0778(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bDrawAtDesiredSize;                                       // 0x0780(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0781(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0784(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x078C(0x0004) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0790(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0798(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x07A8(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x07B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x07BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x07BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x07BE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x07BF(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x07C0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x07C8(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x07E8(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x07F0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x07F8(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0828(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0830(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0831(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                                       // 0x0832(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0838(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0840(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3C];                                      // 0x0844(0x003C) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x0300(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0310(0x0010) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x0320(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PointerIndex;                                             // 0x0324(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x0328(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0329(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x032C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EWidgetInteractionSource                           InteractionSource;                                        // 0x0330(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0331(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0332(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0333(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0334(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7C];                                      // 0x0344(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x03C0(0x0088) (Transient, IsPlainOldData)
	struct FVector2D                                   LocalHitLocation;                                         // 0x0448(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x0450(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0458(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FHitResult                                  LastHitResult;                                            // 0x0460(0x0088) (Transient, IsPlainOldData)
