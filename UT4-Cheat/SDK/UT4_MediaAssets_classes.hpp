...
public:
	...
	struct FName                                       DesiredPlayerName;                                        // 0x0090(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               PlayOnOpen;                                               // 0x0098(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	unsigned char                                      Shuffle : 1;                                              // 0x009C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      Loop : 1;                                                 // 0x009C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x3];                                       // 0x009D(0x0003) MISSED OFFSET
	class UMediaPlaylist*                              Playlist;                                                 // 0x00A0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	int                                                PlaylistIndex;                                            // 0x00A8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x00AC(0x0004) MISSED OFFSET
	class UMediaSoundWave*                             SoundWave;                                                // 0x00B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UMediaTexture*                               VideoTexture;                                             // 0x00B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	struct FName                                       PlayerName;                                               // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<struct FMediaSubtitle>                      Subtitles;                                                // 0x0028(0x0010) (ZeroConstructor)
