...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x09A8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0140(0x01B0) (Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           CustomNavigableGeometry;                                  // 0x02F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FLightingChannels                           LightingChannels;                                         // 0x02F1(0x0003) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      UnknownData10[0x2];                                       // 0x031A(0x0002) MISSED OFFSET
	...
	struct FFloatInterval                              ProceduralScale;                                          // 0x0328(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FRuntimeFloatCurve                          ScaleCurve;                                               // 0x0330(0x0080) (Edit)
	int                                                ChangeCount;                                              // 0x03B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      ReapplyDensity : 1;                                       // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRadius : 1;                                        // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyAlignToNormal : 1;                                 // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRandomYaw : 1;                                     // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaling : 1;                                       // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleX : 1;                                        // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleY : 1;                                        // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyScaleZ : 1;                                        // 0x03B4(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyRandomPitchAngle : 1;                              // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyGroundSlope : 1;                                   // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyHeight : 1;                                        // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyLandscapeLayers : 1;                               // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyZOffset : 1;                                       // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyCollisionWithWorld : 1;                            // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      ReapplyVertexColorMask : 1;                               // 0x03B5(0x0001) (Edit, DisableEditOnInstance)
	unsigned char                                      bEnableDensityScaling : 1;                                // 0x03B5(0x0001) (Edit)
	unsigned char                                      UnknownData11[0xA];                                       // 0x03B6(0x000A) MISSED OFFSET
...
{
public:
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x03C0(0x0010) (Edit, ZeroConstructor)
	class UClass*                                      ComponentClass;                                           // 0x03D0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x03A0(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x03AC(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x03B8(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x03C4(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
