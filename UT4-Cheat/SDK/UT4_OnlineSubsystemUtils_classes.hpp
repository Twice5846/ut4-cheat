...
// 0x0020 (0x336C8 - 0x336A8)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x336A8(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0408(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0408(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0409(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x040C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
