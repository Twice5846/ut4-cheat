...
public:
	...
	struct FString                                     OSSName;                                                  // 0x0380(0x0010) (ZeroConstructor, Config)
	struct FString                                     HotfixManagerClassName;                                   // 0x0390(0x0010) (ZeroConstructor, Config)
	struct FString                                     DebugPrefix;                                              // 0x03A0(0x0010) (ZeroConstructor, Config)
...
public:
	...
	struct FDateTime                                   LastUpdateCheck[0x2];                                     // 0x0238(0x0008) (ZeroConstructor)
