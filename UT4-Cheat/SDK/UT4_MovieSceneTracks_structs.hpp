...
struct FMovieSceneAudioSectionTemplateData
{
	...
	float                                              AudioStartTime;                                           // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AudioDilationFactor;                                      // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AudioVolume;                                              // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                RowIndex;                                                 // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FMovieSceneAudioSectionTemplateData         AudioData;                                                // 0x0018(0x0018)
};
...
{
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                                                   // 0x0018(0x0028)
};
