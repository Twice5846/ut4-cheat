...
{
public:
	unsigned char                                      UnknownData00[0x408];                                     // 0x0358(0x0408) MISSED OFFSET
	class UWheeledVehicleMovementComponent*            WheeledVehicleMovementComponent;                          // 0x0760(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FVector                                     Location;                                                 // 0x00B8(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     OldLocation;                                              // 0x00C4(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     Velocity;                                                 // 0x00D0(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<struct FWheelSetup>                         WheelSetups;                                              // 0x0148(0x0010) (Edit, ZeroConstructor)
	float                                              Mass;                                                     // 0x0158(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DragCoefficient;                                          // 0x015C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisWidth;                                             // 0x0160(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisHeight;                                            // 0x0164(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReverseAsBrake;                                          // 0x0168(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x18];                                      // 0x01B8(0x0018) MISSED OFFSET
	unsigned char                                      bUseRVOAvoidance : 1;                                     // 0x01D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData05[0x3];                                       // 0x01D1(0x0003) MISSED OFFSET
	float                                              RVOAvoidanceRadius;                                       // 0x01D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOAvoidanceHeight;                                       // 0x01D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceConsiderationRadius;                             // 0x01DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOSteeringStep;                                          // 0x01E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOThrottleStep;                                          // 0x01E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AvoidanceUID;                                             // 0x01E8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x01EC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x01F0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x01F4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceWeight;                                          // 0x01F8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector                                     PendingLaunchVelocity;                                    // 0x01FC(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FReplicatedVehicleState                     ReplicatedState;                                          // 0x0208(0x0014) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	float                                              RawSteeringInput;                                         // 0x0220(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawThrottleInput;                                         // 0x0224(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawBrakeInput;                                            // 0x0228(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      UnknownData08[0x2B];                                      // 0x026D(0x002B) MISSED OFFSET
...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x0298(0x0098) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x0330(0x001C) (Edit)
	...
	struct FRuntimeFloatCurve                          SteeringCurve;                                            // 0x0380(0x0080) (Edit)
	float                                              AckermannAccuracy;                                        // 0x0400(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
