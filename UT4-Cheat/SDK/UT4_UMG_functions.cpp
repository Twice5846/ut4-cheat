...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.BackgroundBlurWidget.SetLowQualityFallbackBrush");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.BackgroundBlurWidget.SetBlurStrength");
...
void UBackgroundBlurWidget::SetBlurRadius(int InBlurRadius)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.BackgroundBlurWidget.SetBlurRadius");
...
// Parameters:
// class UObject*                 WorldContextObject             (Parm, ZeroConstructor, IsPlainOldData)
// struct FVector2D               SafePadding                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// struct FVector2D               SafePaddingScale               (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// struct FVector2D               SpillOverPadding               (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// Parameters:
// class UWidget*                 Widget                         (Parm, ZeroConstructor, IsPlainOldData)
// class UBorderSlot*             ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
